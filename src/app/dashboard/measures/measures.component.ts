...
export class Measures extends PlanningBase {
  ...
  constructor(
    ...
    this.subs.push(this.searchService
      .searchCriteria$.subscribe(searchCriteria => {
        ...
        this.vso
          .getMeasures(searchCriteria)
          .then(measures => this.gridData = measures)
          .catch(err => console.log('error retrieving measures', err))
          .then(x => {
